...
class TextShapeUtil extends ShapeUtil {
  ...
  getGeometry(shape, opts) {
    ...
    return new Rectangle2d({
      x: (context === "@tldraw/arrow-start" ? -this.options.extraArrowHorizontalPadding : 0) * scale,
      width: (width + (context === "@tldraw/arrow-start" ? this.options.extraArrowHorizontalPadding * 2 : 0)) * scale,
      height: height * scale,
      isFilled: true,
      isLabel: true
    });
