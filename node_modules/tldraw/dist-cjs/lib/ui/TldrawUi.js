...
const TldrawUiContent = import_react.default.memo(function TldrawUI() {
  ...
  const rHidingTimeout = (0, import_react.useRef)(-1);
  const [hideToolbarWhileEditing, setHideToolbarWhileEditing] = (0, import_react.useState)(false);
  (0, import_editor.useReactor)(
    "update hide toolbar while delayed",
    () => {
      const isMobileEnvironment = import_editor.tlenv.isIos || import_editor.tlenv.isAndroid;
      ...
      if (editingShape === null) {
        if (rIsEditingAnything.current) {
          ...
          if (import_editor.tlenv.isAndroid) {
